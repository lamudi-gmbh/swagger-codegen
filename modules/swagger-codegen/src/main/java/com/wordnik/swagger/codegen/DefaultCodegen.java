  ...
  public CodegenOperation fromOperation(String path, String httpMethod, Operation operation){
    ...
    if(parameters != null) {
      ...
      for(Parameter param : parameters) {
        if (param == null) {
          System.out.println("FUCCCKKKKK THIIIIISSSSSSSS");
          System.out.println("FUCCCKKKKK THIIIIISSSSSSSS " + op.operationId);
          System.out.println("FUCCCKKKKK THIIIIISSSSSSSS " + i);
          System.out.println("FUCCCKKKKK THIIIIISSSSSSSS");
        }
        i++;
